...
x=1
x = int(input("ajouter un autre router ? \nsi oui taper 1:\nsinon taper n'importe ou\n "))

while x==1 :
    router_ip = input(f"Enter the IP address for router : ")
    username = input(f"Enter the username for router : ")
    password = input(f"Enter the password for router : ")
